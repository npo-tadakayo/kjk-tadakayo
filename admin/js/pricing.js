...
//
// ★ CIR415A-01（BT）は台数によらず 8,000円（2026-08-31 次田さん確認）。
//   ここに以前 [8000,8000,7530,7530] と書かれていたが、本番の設定・実際の請求はいずれも
//   全段階 8,000円で運用されている。説明動画の撮影中に食い違いが見つかり、
//   「認定事業者への販売なので 8,000円が正しい」と確認が取れたため、確定値のほうを実態に合わせた。
//   過去の請求（直送3件・税別 ¥136,300 の差）も、そのままで正しい。
const PRODUCTS = [
  ["cir415a-01","CIR415A-01（BT）",[8000,8000,8000,8000]],
