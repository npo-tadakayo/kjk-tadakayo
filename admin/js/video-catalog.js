...
export const VIDEOS = [
  { id: "U1", no: 1, title: "はじめに・全体像", duration: "4分42秒", version: "v1.0", updated: "2026-08-31",
  ...
  { id: "U2", no: 2, title: "案件を進める", duration: "6分12秒", version: "v1.0", updated: "2026-08-31",
    ...
    roles: ["全員"] },
  { id: "U3", no: 3, title: "発注と出荷", duration: "5分46秒", version: "v1.0", updated: "2026-08-31",
  ...
  { id: "U5", no: 5, title: "認定事業者とのやりとり", duration: "3分36秒", version: "v1.2", updated: "2026-09-06",
    ...
    roles: ["供給管理"] },
  { id: "U6", no: 6, title: "設定と管理", duration: "4分55秒", version: "v1.0", updated: "2026-08-31",
    desc: "ユーザー管理、通知先、書類、紹介元の種類、料金・送料", file: "crm-u6",
    roles: ["管理者"] },
  { id: "U7", no: 7, title: "伴走支援の記録", duration: "6分08秒", version: "v1.0", updated: "2026-08-31",
