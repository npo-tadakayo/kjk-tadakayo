...
- index.html 制作完了・Firebase Hosting デプロイ済み
- GitHub push 済み（tsuku-29/kjk-tadakayo）
...
ICT導入支援事業（割合型）と介護情報基盤助成金（定額型）を比較した結果、定額型が大幅に有利と判明。¥61,000パックは定額型の税込上限¥64,000以内に収まるよう設計。
...
| 2026-05-07 | ENGINEERING_NOTES.md 作成 |
