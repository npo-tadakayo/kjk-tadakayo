...
|---|---|---|
| 1 | **Formspree の扱い**（問い合わせ内容が外部にも送られている・住所4項目が増えた） | 止める → `index.html` の Formspree 送信を外して lp 再デプロイ ／ 残す → 台帳とプライバシーポリシーに記載を足す |
...
| 4 | 介護情報基盤の部門保護管理者はどなたか | PMS事務局への報告手続き（連携ルール §5-2）に必要 |
