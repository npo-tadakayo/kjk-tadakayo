...
-0.4. **問い合わせ・見積もり・注文の統合**: 計画書 `docs/問い合わせ・見積もり・注文の統合_実装計画_20260906.md` を提示済み（未着手）。§7 の7論点（承諾書を申し込み時に取るか／有効期限／支払方法／USB Type選択／ラベル変更／直送判断／2ページ維持）の回答待ち → Phase 1（案件を1本にする・quotes 新設）から着手
